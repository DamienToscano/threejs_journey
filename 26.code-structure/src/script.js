...
// There is a github repo on bruno simon github profil to have a reasy to go complex project

// A class Experience to handle the whole experience
import Experience from './Experience/Experience.js'
// Instantiate the experience and send the canvas related
const experience = new Experience(document.querySelector('canvas.webgl'))

// Make a Utils folder to handle usefull classes
